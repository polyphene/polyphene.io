    ...
    <Layout>
        ...
        <div className={"container"}>
            <div className={"content"}>
                ...
                <p>This Policy describes the information we collect from you, how we use that information and our legal basis for doing so. It also covers whether and how that information may be shared and your rights and choices regarding the information you provide to us. This Privacy Policy applies to the information that we obtain through your use of Evidence websites including its subdomain <a href={"https://blog.evidence.fyi"}>blog.evidence.fyi</a>.</p>

                <h3>Who We Are</h3>
                <p>
                    Evidence is a project brought to you by the Evidence team members as well as many other contributors around the globe.<br/>
                    If you have any questions about this privacy policy, please contact our team at <a href={"mailto:contact@evidence.fyi"}>contact@evidence.fyi</a>.
                </p>
                ...
                <p>
                    ...
                    <ul>
                        <li>Contact us via email — for example, when you send us questions or comments, report a problem or subscribe to our newsletter, we may collect your name, email address, message, etc. We use this data solely in connection with answering the queries we receive.</li>
                        <li>Usage data — when you visit our site, we will store: the website from which you visited us from, the parts of our site you visit, the date and duration of your visit, your anonymised IP address, information from the device (device type, operating system, screen resolution, language, country you are located in, and web browser type) you used during your visit, and more. We process this usage data in Matomo Analytics for statistical purposes, to improve our site and to recognize and stop any misuse.</li>
                    </ul>
                </p>
                ...
                <h3>Contact Us</h3>
                <p>
                    Email: <a href={"mailto:contact@evidence.fyi"}>contact@evidence.fyi</a>.<br/>
                    Contact form: <a href={"https://evidence.fyi/contact"}>https://evidence.fyi/contact</a>.
                </p>
            </div>
        </div>
    </Layout>
