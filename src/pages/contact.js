  ...
  return (
    <Layout>
      ...
      <div className={"page-header"}>
        <h2>Contact</h2>
        <p>
          Building a community in the hope of best meeting its expectations is
        ...
        <div className={"content"}>
          <div className={"row"}>
                ...
                {showSuccess ? (
                  <div>
                    <p>
                      ...
                      <br />A member of our team will follow up shortly.
                    </p>
                    <input
                      type="submit"
                      value="Reset Contact Form"
                      onClick={() => {
            ...
            <div className={"col-5"}>
              ...
              <p>
                Please use this form to get in touch and/or subscribe to our
                newsletter.
              </p>
              <p>
